...
%type<nd_obj2> logical_o_exp logical_a_exp relational_exp additive_exp multiplicative_exp negation_exp access_call_exp primary_exp constant  expression_statement
...
if_statement:
        IF LPAREN expression_statement RPAREN compound_statement   {   $$.nd = mknode($3.nd, $5.nd, "IF"); }
        |   IF LPAREN expression_statement RPAREN compound_statement ELSE compound_statement
                                                                        {
                                                                        $1.nd = mknode($3.nd,$5.nd,"IF");
                                                                        $6.nd = mknode($7.nd,NULL,"ELSE");
                                                                        $$.nd = mknode($1.nd,$6.nd,"IF_statement");
                                                                        }
...
assignment_statement_2: ID ASSIGNMENT expression_statement  {   
        ...
        | ID LSQBRACKET ID RSQBRACKET ASSIGNMENT expression_statement{
...
for_update:
        assignment_statement_2  {   $$.nd = mknode($1.nd, NULL, "for_update");  }
